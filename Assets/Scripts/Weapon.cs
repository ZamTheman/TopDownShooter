...
public class Weapon : MonoBehaviour
{
    ...
    public void Shoot()
    {
        ...
        currentFlare = Instantiate(Flare, GunPoint.position, GunPoint.rotation);
        currentFlare.transform.localScale = new Vector3(flareScaleX, flareScaleY, 1);
        currentFlare.transform.Rotate(0, 0, -90);
        StartCoroutine(FadeRoutine(currentFlare.GetComponent<Renderer>()));
